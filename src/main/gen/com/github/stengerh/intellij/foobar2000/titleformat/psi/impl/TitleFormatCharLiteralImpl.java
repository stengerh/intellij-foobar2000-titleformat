...
public class TitleFormatCharLiteralImpl extends ASTWrapperPsiElement implements TitleFormatCharLiteral {

  public TitleFormatCharLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
