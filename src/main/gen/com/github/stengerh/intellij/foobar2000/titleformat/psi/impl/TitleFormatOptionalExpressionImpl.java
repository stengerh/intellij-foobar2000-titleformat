...
public class TitleFormatOptionalExpressionImpl extends ASTWrapperPsiElement implements TitleFormatOptionalExpression {

  public TitleFormatOptionalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
