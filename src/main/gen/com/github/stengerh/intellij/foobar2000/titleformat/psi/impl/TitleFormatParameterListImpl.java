...
public class TitleFormatParameterListImpl extends ASTWrapperPsiElement implements TitleFormatParameterList {

  public TitleFormatParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }
